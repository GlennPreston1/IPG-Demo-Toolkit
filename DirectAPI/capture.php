...
<html>
	...
	<body onload="initSession()">
		...
		<div class="container my-4">
			<div class="text text-center mb-4"><h2><strong>Direct API - Capture</strong></h2></div>
				...
				<div class="row">
					<div class="col">
						...
						<div class="form-group">
							...
							<input class="form-control form-control-sm" id="amountInput" name="amount">
						</div>
					</div>
					...
					<div class="col">
						<div class="form-group">
							...
							<input class="form-control form-control-sm" id="actionInput" name="action" value="CAPTURE">
						</div>
