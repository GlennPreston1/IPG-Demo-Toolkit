...
<html>
	...
	<body onload="initSession()">
		...
		<div class="container my-4">
			<div class="text text-center mb-4"><h2><strong>Direct API - Tokenize</strong></h2></div>
				...
				<div class="row">
					...
					<div class="col">
						<div class="form-group">
							...
							<input class="form-control form-control-sm" id="actionInput" name="action" value="TOKENIZE">
						</div>
			...
			<form id="actionForm">
				<div class="row">
					<div class="col">
						...
						<div class="form-group">
							<label class="m-0" for="nameOnCardInput">nameOnCard</label>
							<input class="form-control form-control-sm" id="nameOnCardInput" name="nameOnCard" value="Test">
						</div>

						<div class="form-group">
							<label class="m-0" for="expiryMonthInput">expiryMonth</label>
							<input class="form-control form-control-sm" id="expiryMonthInput" name="expiryMonth" value="01">
						</div>
					</div>
					...
					<div class="col">
						...
						<div class="form-group">
							<label class="m-0" for="numberInput">number</label>
							<input class="form-control form-control-sm" id="numberInput" name="number" value="5454545454545454">
						</div>

						<div class="form-group">
							<label class="m-0" for="expiryYearInput">expiryYear</label>
							<input class="form-control form-control-sm" id="expiryYearInput" name="expiryYear" value="2025">
						</div>
					</div>
				</div>
